...
public class UserGuideFragment6 extends Fragment {
    private TextView count;


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_user_guide6, container, false);

        count = (TextView) rootView.findViewById(R.id.count_bt6);
        ...
        ImageView img = rootView.findViewById(R.id.infoImg_6);
        Glide.with(img).load(R.drawable.g6).override(500).into(img);
