...
public class UserGuideFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_user_guide2, container, false);

        count = (TextView) rootView.findViewById(R.id.count_bt2);
        ...
        ImageView img = rootView.findViewById(R.id.infoImg_2);
        Glide.with(img).load(R.drawable.g2).override(500).into(img);
