...
public class UserGuideFragment8 extends Fragment {
    private TextView count;


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_user_guide8, container, false);

        count = (TextView) rootView.findViewById(R.id.count_bt8);
        ...
        ImageView img = rootView.findViewById(R.id.infoImg_8);
        Glide.with(img).load(R.drawable.g8).override(500).into(img);
