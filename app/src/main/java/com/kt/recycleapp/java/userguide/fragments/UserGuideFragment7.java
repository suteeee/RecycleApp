...
public class UserGuideFragment7 extends Fragment {
    private TextView count;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_user_guide7, container, false);

        count = (TextView) rootView.findViewById(R.id.count_bt7);
        ...
        ImageView img = rootView.findViewById(R.id.infoImg_7);
        Glide.with(img).load(R.drawable.g7).override(500).into(img);
