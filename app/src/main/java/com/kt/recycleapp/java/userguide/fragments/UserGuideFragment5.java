...
public class UserGuideFragment5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_user_guide5, container, false);

        count = (TextView) rootView.findViewById(R.id.count_bt5);
        ...
        ImageView img = rootView.findViewById(R.id.infoImg_5);
        Glide.with(img).load(R.drawable.g5).override(500).into(img);
