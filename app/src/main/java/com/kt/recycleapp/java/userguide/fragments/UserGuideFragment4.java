...
public class UserGuideFragment4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_user_guide4, container, false);

        count = (TextView) rootView.findViewById(R.id.count_bt4);
        ...
        ImageView img = rootView.findViewById(R.id.infoImg_4);
        Glide.with(img).load(R.drawable.g4).override(500).into(img);
