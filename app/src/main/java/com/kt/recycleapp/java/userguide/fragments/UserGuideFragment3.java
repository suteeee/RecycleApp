...
public class UserGuideFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        count = (TextView) rootView.findViewById(R.id.count_bt3);
        ...
        ImageView img = rootView.findViewById(R.id.infoImg_3);
        Glide.with(img).load(R.drawable.g3).override(500).into(img);
